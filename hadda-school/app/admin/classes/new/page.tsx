  ...
  return (
    <div className="p-6 max-w-xl">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-coffee-900 mt-2">Create New Class</h1>
      </div>

      <form action={handleSubmit} className="bg-white border border-coffee-200 rounded-xl p-6 space-y-4">
        <div>
