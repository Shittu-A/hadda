        ...
        <form action={handleCreate} className="flex flex-wrap gap-4 items-end">
          <div>
            ...
            <input
              ...
              className="border border-coffee-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-coffee-400 w-40"
            />
          </div>
          <div>
            ...
            <input
              ...
              name="startDate"
              required
              className="border border-coffee-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-coffee-400"
            />
          </div>
          <div>
        ...
        <table className="w-full text-sm">
          <thead className="bg-coffee-50 border-b border-coffee-200">
            <tr>
              ...
              <th className="text-left px-5 py-3 text-coffee-700 font-semibold">Start Date</th>
              <th className="text-left px-5 py-3 text-coffee-700 font-semibold">End Date</th>
              ...
              academicYears.map((year) => {
                ...
                return (
                  <tr key={year.id} className="hover:bg-coffee-50 transition-colors">
                    <td className="px-5 py-3 font-medium text-coffee-900">{year.name}</td>
                    <td className="px-5 py-3 text-coffee-600">{formatDate(year.startDate)}</td>
                    <td className="px-5 py-3 text-coffee-600">{formatDate(year.endDate)}</td>
                    <td className="px-5 py-3 text-coffee-600">{count}</td>
