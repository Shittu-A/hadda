...
export const adminLinks = [
  ...
  { href: '/admin/applications', label: 'Applications', icon: <Inbox size={18} />, permission: 'applications_manage' },
  { href: '/admin/students', label: 'Students', icon: <GraduationCap size={18} />, permission: 'students_manage' },
  { href: '/admin/classes', label: 'Classes', icon: <Users size={18} />, permission: 'classes_manage' },
  { href: '/admin/attendance/students', label: 'Student Attendance', icon: <CalendarCheck size={18} />, permission: 'student_attendance_manage' },
  ...
  { href: '/admin/reports', label: 'Reports', icon: <BarChart3 size={18} />, permission: 'reports_view' },
  { href: '/admin/teacher-profiles', label: 'Teacher Profiles', icon: <IdCard size={18} />, permission: 'teacher_profiles_manage' },
  { href: '/admin/activity-monitoring', label: 'Activity Monitoring', icon: <Activity size={18} />, permission: 'activity_monitoring_view' },
